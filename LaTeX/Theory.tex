...
\begin{align}
    f(\textbf{X}) = \beta_0 + \sum^{p}_{i=1} X_i \beta_i %\cite{hastie_09_elements-of.statistical-learning} \label{linear model}
\end{align}
...
linear regression model given in equation %\eqref{linear model} and minimizing the MSE \cite{AY}.
